...
final class TriStateToggleableNode extends ClickableNode {
    ...
    public final void m938updateQzZPfjk(ToggleableState state, MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, Role role, Function0<Unit> onClick) {
        if (this.state != state) {
            this.state = state;
