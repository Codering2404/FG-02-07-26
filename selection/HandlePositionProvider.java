...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    private long prevPosition = Offset.INSTANCE.m3937getZeroF1C5BW0();
    ...
    public long mo337calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        long $this$takeOrElse_u2d3MmeM6k$iv = this.positionProvider.mo962provideF1C5BW0();
        if (!OffsetKt.m3940isSpecifiedk4lQ0M($this$takeOrElse_u2d3MmeM6k$iv)) {
            $this$takeOrElse_u2d3MmeM6k$iv = this.prevPosition;
        }
        this.prevPosition = $this$takeOrElse_u2d3MmeM6k$iv;
        long adjustment = this.handleReferencePoint.mo3767alignKFBX0sM(popupContentSize, IntSize.INSTANCE.m6800getZeroYbymL2g(), layoutDirection);
        return IntOffset.m6757plusqkQi6aY(IntOffset.m6757plusqkQi6aY(anchorBounds.m6781getTopLeftnOccac(), IntOffsetKt.m6769roundk4lQ0M($this$takeOrElse_u2d3MmeM6k$iv)), adjustment);
    }
}
