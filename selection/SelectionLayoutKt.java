...
public final class SelectionLayoutKt {
    ...
    public static final SelectionLayout m1332getTextFieldSelectionLayoutRcvTLA(TextLayoutResult layoutResult, int rawStartHandleOffset, int rawEndHandleOffset, int rawPreviousHandleOffset, long previousSelectionRange, boolean isStartOfSelection, boolean isStartHandle) {
        return new SingleSelectionLayout(isStartHandle, 1, 1, isStartOfSelection ? null : new Selection(new Selection.AnchorInfo(getTextDirectionForOffset(layoutResult, TextRange.m6091getStartimpl(previousSelectionRange)), TextRange.m6091getStartimpl(previousSelectionRange), 1L), new Selection.AnchorInfo(getTextDirectionForOffset(layoutResult, TextRange.m6086getEndimpl(previousSelectionRange)), TextRange.m6086getEndimpl(previousSelectionRange), 1L), TextRange.m6090getReversedimpl(previousSelectionRange)), new SelectableInfo(1L, 1, rawStartHandleOffset, rawEndHandleOffset, rawPreviousHandleOffset, layoutResult));
    }
