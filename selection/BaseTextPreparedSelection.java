...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final void m1313setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final T deselect() {
        ...
        if (getText$foundation_release().length() > 0) {
            BaseTextPreparedSelection<T> baseTextPreparedSelection = this;
            baseTextPreparedSelection.setCursor(TextRange.m6086getEndimpl(baseTextPreparedSelection.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    public final T collapseLeftOr(Function1<? super T, Unit> or) {
        ...
        if (getText$foundation_release().length() > 0) {
            BaseTextPreparedSelection<T> baseTextPreparedSelection = this;
            if (TextRange.m6085getCollapsedimpl(baseTextPreparedSelection.selection)) {
                ...
                if (zIsLtr) {
                    baseTextPreparedSelection.setCursor(TextRange.m6089getMinimpl(j));
                } else {
                    baseTextPreparedSelection.setCursor(TextRange.m6088getMaximpl(j));
                }
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.annotatedString.getText(), TextRange.m6086getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.annotatedString.getText(), TextRange.m6086getEndimpl(this.selection));
    }
    ...
    private final T moveCursorPrev() {
        ...
        int prev;
        getState().resetCachedX();
        if ((getText$foundation_release().length() > 0) && (prev = (baseTextPreparedSelection = this).getPrecedingCharacterIndex()) != -1) {
    ...
    private final T moveCursorNext() {
        ...
        int next;
        getState().resetCachedX();
        if ((getText$foundation_release().length() > 0) && (next = (baseTextPreparedSelection = this).getNextCharacterIndex()) != -1) {
    ...
    private final T moveCursorNextByWord() {
        ...
        getState().resetCachedX();
        if ((getText$foundation_release().length() > 0) && (nextWordOffset = (baseTextPreparedSelection = this).getNextWordOffset()) != null) {
    ...
    private final T moveCursorPrevByWord() {
        ...
        getState().resetCachedX();
        if ((getText$foundation_release().length() > 0) && (previousWordOffset = (baseTextPreparedSelection = this).getPreviousWordOffset()) != null) {
    ...
    public final T moveCursorPrevByParagraph() {
        ...
        if (getText$foundation_release().length() > 0) {
            BaseTextPreparedSelection<T> baseTextPreparedSelection = this;
            int paragraphStart = StringHelpersKt.findParagraphStart(baseTextPreparedSelection.getText$foundation_release(), TextRange.m6089getMinimpl(baseTextPreparedSelection.selection));
            if (paragraphStart == TextRange.m6089getMinimpl(baseTextPreparedSelection.selection) && paragraphStart != 0) {
                paragraphStart = StringHelpersKt.findParagraphStart(baseTextPreparedSelection.getText$foundation_release(), paragraphStart - 1);
            }
    ...
    public final T moveCursorNextByParagraph() {
        ...
        if (getText$foundation_release().length() > 0) {
            BaseTextPreparedSelection<T> baseTextPreparedSelection = this;
            int paragraphEnd = StringHelpersKt.findParagraphEnd(baseTextPreparedSelection.getText$foundation_release(), TextRange.m6088getMaximpl(baseTextPreparedSelection.selection));
            if (paragraphEnd == TextRange.m6088getMaximpl(baseTextPreparedSelection.selection) && paragraphEnd != baseTextPreparedSelection.getText$foundation_release().length()) {
                paragraphEnd = StringHelpersKt.findParagraphEnd(baseTextPreparedSelection.getText$foundation_release(), paragraphEnd + 1);
            }
    ...
    public final T moveCursorUpByLine() {
        ...
        if ((getText$foundation_release().length() > 0) && (textLayoutResult = (baseTextPreparedSelection = this).layoutResult) != null) {
    ...
    public final T moveCursorToLineStart() {
        ...
        getState().resetCachedX();
        if ((getText$foundation_release().length() > 0) && (lineStartByOffset = (baseTextPreparedSelection = this).getLineStartByOffset()) != null) {
    ...
    public final T moveCursorToLineEnd() {
        ...
        getState().resetCachedX();
        if ((getText$foundation_release().length() > 0) && (lineEndByOffset = (baseTextPreparedSelection = this).getLineEndByOffset()) != null) {
    ...
    public final T selectMovement() {
        if (getText$foundation_release().length() > 0) {
            BaseTextPreparedSelection<T> baseTextPreparedSelection = this;
            baseTextPreparedSelection.selection = TextRangeKt.TextRange(TextRange.m6091getStartimpl(baseTextPreparedSelection.originalSelection), TextRange.m6086getEndimpl(baseTextPreparedSelection.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult $this$getNextWordOffsetForLayout, int currentOffset) {
        while (currentOffset < this.originalText.length()) {
            long currentWord = $this$getNextWordOffsetForLayout.m6065getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m6086getEndimpl(currentWord) <= currentOffset) {
                currentOffset++;
            } else {
                return this.offsetMapping.transformedToOriginal(TextRange.m6086getEndimpl(currentWord));
            }
        }
    ...
    private final int getPrevWordOffset(TextLayoutResult $this$getPrevWordOffset, int currentOffset) {
        while (currentOffset > 0) {
            long currentWord = $this$getPrevWordOffset.m6065getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m6091getStartimpl(currentWord) >= currentOffset) {
                currentOffset--;
            } else {
                return this.offsetMapping.transformedToOriginal(TextRange.m6091getStartimpl(currentWord));
            }
        }
        return 0;
    }
    ...
    private final int jumpByLinesOffset(TextLayoutResult $this$jumpByLinesOffset, int linesAmount) {
        ...
        if ((!isLtr() || it < $this$jumpByLinesOffset.getLineRight(targetLine)) && (isLtr() || it > $this$jumpByLinesOffset.getLineLeft(targetLine))) {
            ...
            return this.offsetMapping.transformedToOriginal($this$jumpByLinesOffset.m6063getOffsetForPositionk4lQ0M(OffsetKt.Offset(x, y)));
        }
        return $this$jumpByLinesOffset.getLineEnd(targetLine, true);
    }

    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m6086getEndimpl(this.selection));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m6089getMinimpl(this.selection));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m6088getMaximpl(this.selection));
    }
