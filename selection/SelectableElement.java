...
final class SelectableElement extends ModifierNodeElement<SelectableNode> {
    ...
    public void update(SelectableNode node) {
        node.m928updateQzZPfjk(this.selected, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((result4 + (role != null ? Role.m5898hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode();
    }
}
