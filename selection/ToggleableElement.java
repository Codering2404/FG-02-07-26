...
final class ToggleableElement extends ModifierNodeElement<ToggleableNode> {
    ...
    public void update(ToggleableNode node) {
        node.m937updateQzZPfjk(this.value, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onValueChange);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        $this$inspectableProperties.setName("toggleable");
        $this$inspectableProperties.getProperties().set(AppMeasurementSdk.ConditionalUserProperty.VALUE, $this$inspectableProperties.getValue());
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((result4 + (role != null ? Role.m5898hashCodeimpl(role.getValue()) : 0)) * 31) + this.onValueChange.hashCode();
    }
}
