...
public final class SelectionColors {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SelectionColors) && Color.m4163equalsimpl0(this.selectionHandleColor, ((SelectionColors) other).selectionHandleColor) && Color.m4163equalsimpl0(this.selectionBackgroundColor, ((SelectionColors) other).selectionBackgroundColor);
    }

    public int hashCode() {
        int result = Color.m4169hashCodeimpl(this.selectionHandleColor);
        return (result * 31) + Color.m4169hashCodeimpl(this.selectionBackgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) Color.m4170toStringimpl(this.selectionHandleColor)) + ", selectionBackgroundColor=" + ((Object) Color.m4170toStringimpl(this.selectionBackgroundColor)) + ')';
    }
}
