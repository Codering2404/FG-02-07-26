...
public final class ScrollState implements ScrollableState {
    ...
    private final ScrollableState scrollableState = ScrollableStateKt.ScrollableState(new Function1<Float, Float>() { // from class: androidx.compose.foundation.ScrollState$scrollableState$1
        ...
        public final Float invoke(float it) {
            float absolute = this.this$0.getValue() + it + this.this$0.accumulator;
            float newValue = RangesKt.coerceIn(absolute, 0.0f, this.this$0.getMaxValue());
            boolean changed = !(absolute == newValue);
            float consumed = newValue - this.this$0.getValue();
            int consumedInt = Math.round(consumed);
            ScrollState scrollState = this.this$0;
            scrollState.setValue(scrollState.getValue() + consumedInt);
            this.this$0.accumulator = consumed - consumedInt;
