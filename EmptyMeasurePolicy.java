...
final class EmptyMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo33measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, Constraints.m6578getMaxWidthimpl(constraints), Constraints.m6577getMaxHeightimpl(constraints), null, placementBlock, 4, null);
    }
}
