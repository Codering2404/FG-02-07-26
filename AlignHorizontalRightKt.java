...
public final class AlignHorizontalRightKt {
    ...
    public static final ImageVector getAlignHorizontalRight(Icons.AutoMirrored.TwoTone $this$AlignHorizontalRight) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _alignHorizontalRight = ImageVector.Builder.m4845addPathoIyEayM$default($this$_get_AlignHorizontalRight__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
