...
public final class Clickable_androidKt {
    ...
    public static final boolean m275isPressZmokQxo(KeyEvent $this$isPress) {
        return KeyEventType.m5212equalsimpl0(KeyEvent_androidKt.m5220getTypeZmokQxo($this$isPress), KeyEventType.INSTANCE.m5216getKeyDownCS__XNY()) && m274isEnterZmokQxo($this$isPress);
    }

    /* JADX INFO: renamed from: isClick-ZmokQxo, reason: not valid java name */
    public static final boolean m273isClickZmokQxo(KeyEvent $this$isClick) {
        return KeyEventType.m5212equalsimpl0(KeyEvent_androidKt.m5220getTypeZmokQxo($this$isClick), KeyEventType.INSTANCE.m5217getKeyUpCS__XNY()) && m274isEnterZmokQxo($this$isClick);
    }

    /* JADX INFO: renamed from: isEnter-ZmokQxo, reason: not valid java name */
    private static final boolean m274isEnterZmokQxo(KeyEvent $this$isEnter) {
        switch (Key_androidKt.m5226getNativeKeyCodeYVgTNJs(KeyEvent_androidKt.m5219getKeyZmokQxo($this$isEnter))) {
            case 23:
            case 66:
            case 160:
                return true;
