...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m6625constructorimpl(10);
    ...
    public static final float m1745getRippleStartRadiusuvyYCjk(long size) {
        return Math.max(Size.m3990getWidthimpl(size), Size.m3987getHeightimpl(size)) * 0.3f;
    }

    /* JADX INFO: renamed from: getRippleEndRadius-cSwnlzA, reason: not valid java name */
    public static final float m1744getRippleEndRadiuscSwnlzA(Density $this$getRippleEndRadius_u2dcSwnlzA, boolean bounded, long size) {
        float radiusCoveringBounds = Offset.m3919getDistanceimpl(OffsetKt.Offset(Size.m3990getWidthimpl(size), Size.m3987getHeightimpl(size))) / 2.0f;
        if (bounded) {
            return $this$getRippleEndRadius_u2dcSwnlzA.mo365toPx0680j_4(BoundedRippleExtraRadius) + radiusCoveringBounds;
        }
