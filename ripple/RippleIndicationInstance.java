...
public abstract class RippleIndicationInstance implements IndicationInstance {
    ...
    public final void m1748drawStateLayerH2RKhps(DrawScope $this$drawStateLayer_u2dH2RKhps, float radius, long color) {
        float targetRadius;
        StateLayer $this$drawStateLayer_H2RKhps_u24lambda_u240 = this.stateLayer;
        if (Float.isNaN(radius)) {
            targetRadius = RippleAnimationKt.m1744getRippleEndRadiuscSwnlzA($this$drawStateLayer_u2dH2RKhps, this.bounded, $this$drawStateLayer_u2dH2RKhps.mo4712getSizeNHjbRc());
        } else {
            targetRadius = $this$drawStateLayer_u2dH2RKhps.mo365toPx0680j_4(radius);
        }
        $this$drawStateLayer_H2RKhps_u24lambda_u240.m1756drawStateLayermxwnekA($this$drawStateLayer_u2dH2RKhps, targetRadius, color);
    }
}
