...
public final class RippleHostView extends View {
    ...
    public final void m1746addRippleKOepWvA(PressInteraction.Press interaction, boolean bounded, long size, int radius, long color, float alpha, Function0<Unit> onInvalidateRipple) {
        ...
        m1747setRippleProperties07v42R4(size, color, alpha);
        if (bounded) {
            ripple.setHotspot(Offset.m3921getXimpl(interaction.getPressPosition()), Offset.m3922getYimpl(interaction.getPressPosition()));
        } else {
    ...
    public final void m1747setRippleProperties07v42R4(long size, long color, float alpha) {
        UnprojectedRipple ripple = this.ripple;
        if (ripple == null) {
            return;
        }
        ripple.m1758setColorDxMtmZc(color, alpha);
        Rect newBounds = new Rect(0, 0, MathKt.roundToInt(Size.m3990getWidthimpl(size)), MathKt.roundToInt(Size.m3987getHeightimpl(size)));
