...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1502defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long jM1754defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1754defaultRippleColor5vOe2sY(Color.INSTANCE.m4188getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
        return jM1754defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        RippleAlpha rippleAlphaM1753defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1753defaultRippleAlphaDxMtmZc(Color.INSTANCE.m4188getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
        return rippleAlphaM1753defaultRippleAlphaDxMtmZc;
    }
}
