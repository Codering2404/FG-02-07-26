...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1758setColorDxMtmZc(long color, float alpha) {
        long newColor = m1757calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (!(color2 == null ? false : Color.m4163equalsimpl0(color2.m4172unboximpl(), newColor))) {
            this.rippleColor = Color.m4152boximpl(newColor);
            setColor(ColorStateList.valueOf(ColorKt.m4216toArgb8_81llA(newColor)));
        }
    }
    ...
    private final long m1757calculateRippleColor5vOe2sY(long color, float alpha) {
        float f;
        ...
        return Color.m4160copywmQWz5c(color, (14 & 1) != 0 ? Color.m4164getAlphaimpl(color) : transformedAlpha, (14 & 2) != 0 ? Color.m4168getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m4167getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m4165getBlueimpl(color) : 0.0f);
    }
