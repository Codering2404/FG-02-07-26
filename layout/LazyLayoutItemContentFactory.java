        ...
        private final Function2<Composer, Integer, Unit> createContentLambda() {
            ...
            return ComposableLambdaKt.composableLambdaInstance(1403994769, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutItemContentFactory$CachedItemContent$createContentLambda$1
                ...
                public final void invoke(Composer $composer, int $changed) {
                    int index;
                    Object value$iv;
                    ComposerKt.sourceInformation($composer, "C99@3690L258,107@3983L197,107@3961L219:LazyLayoutItemContentFactory.kt#wow0x6");
                    if (($changed & 3) != 2 || !$composer.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(1403994769, $changed, -1, "androidx.compose.foundation.lazy.layout.LazyLayoutItemContentFactory.CachedItemContent.createContentLambda.<anonymous> (LazyLayoutItemContentFactory.kt:91)");
                        }
                        LazyLayoutItemProvider itemProvider = lazyLayoutItemContentFactory.getItemProvider().invoke();
                        ...
                        if (active$iv) {
                            ...
                            ComposerKt.sourceInformation($composer, "C100@3750L184:LazyLayoutItemContentFactory.kt#wow0x6");
                            LazyLayoutItemContentFactoryKt.m841SkippableItemJVlU9Rs(itemProvider, StableValue.m861constructorimpl(lazyLayoutItemContentFactory2.saveableStateHolder), index, StableValue.m861constructorimpl(cachedItemContent.getKey()), $composer, 0);
                        ...
                        ComposerKt.sourceInformationMarkerStart($composer, -714032874, "CC(remember):LazyLayoutItemContentFactory.kt#9igjgp");
