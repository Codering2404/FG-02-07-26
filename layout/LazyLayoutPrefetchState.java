...
public final class LazyLayoutPrefetchState {
    ...
    public final PrefetchHandle schedulePrefetch(int index) {
        return m845schedulePrefetch0kLqBqw(index, LazyLayoutPrefetchStateKt.ZeroConstraints);
    }
    ...
    public final PrefetchHandle m845schedulePrefetch0kLqBqw(int index, long constraints) {
        PrefetchHandle prefetchHandleM858schedulePrefetchVKLhPVY;
        PrefetchHandleProvider prefetchHandleProvider = this.prefetchHandleProvider;
        if (prefetchHandleProvider != null && (prefetchHandleM858schedulePrefetchVKLhPVY = prefetchHandleProvider.m858schedulePrefetchVKLhPVY(index, constraints, this.prefetchMetrics)) != null) {
            return prefetchHandleM858schedulePrefetchVKLhPVY;
        }
    ...
    private final class NestedPrefetchScopeImpl implements NestedPrefetchScope {
        ...
        public void schedulePrefetch(int index) {
            mo846schedulePrefetch0kLqBqw(index, LazyLayoutPrefetchStateKt.ZeroConstraints);
        }
