    ...
    public static abstract class Status {
        ...
        public static final class Open extends Status {
            ...
            private Open(long offset) {
                super(null);
                this.offset = offset;
                if (!OffsetKt.m3940isSpecifiedk4lQ0M(this.offset)) {
                    throw new IllegalStateException("ContextMenuState.Status should never be open with an unspecified offset. Use ContextMenuState.Status.Closed instead.".toString());
                }
            }

            public String toString() {
                return "Open(offset=" + ((Object) Offset.m3929toStringimpl(this.offset)) + ')';
            }

            public int hashCode() {
                return Offset.m3923hashCodeimpl(this.offset);
            }
            ...
            public boolean equals(Object other) {
                ...
                if (other instanceof Open) {
                    return Offset.m3918equalsimpl0(this.offset, ((Open) other).offset);
                }
                return false;
            }
        }
