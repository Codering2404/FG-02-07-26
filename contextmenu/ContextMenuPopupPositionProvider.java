...
public final class ContextMenuPopupPositionProvider implements PopupPositionProvider {
    ...
    public long mo337calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        return IntOffsetKt.IntOffset(ContextMenuPopupPositionProvider_androidKt.alignPopupAxis(anchorBounds.getLeft() + IntOffset.m6753getXimpl(this.localPosition), IntSize.m6795getWidthimpl(popupContentSize), IntSize.m6795getWidthimpl(windowSize), layoutDirection == LayoutDirection.Ltr), ContextMenuPopupPositionProvider_androidKt.alignPopupAxis$default(anchorBounds.getTop() + IntOffset.m6754getYimpl(this.localPosition), IntSize.m6794getHeightimpl(popupContentSize), IntSize.m6794getHeightimpl(windowSize), false, 8, null));
    }
}
