...
public final class SelectionControllerKt {
    ...
    public static final Modifier makeSelectionModifier(final SelectionRegistrar $this$makeSelectionModifier, final long selectableId, final Function0<? extends LayoutCoordinates> function0) {
        TextDragObserver textDragObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$longPressDragObserver$1
            private long lastPosition = Offset.INSTANCE.m3937getZeroF1C5BW0();
            private long dragTotalDistance = Offset.INSTANCE.m3937getZeroF1C5BW0();
            ...
            public void mo1051onStartk4lQ0M(long startPoint) {
                ...
                if (it != null) {
                    ...
                    selectionRegistrar.mo1376notifySelectionUpdateStartubNVwUQ(it, startPoint, SelectionAdjustment.INSTANCE.getWord(), true);
                    this.lastPosition = startPoint;
                }
                if (SelectionRegistrarKt.hasSelection($this$makeSelectionModifier, selectableId)) {
                    this.dragTotalDistance = Offset.INSTANCE.m3937getZeroF1C5BW0();
                }
            }
            ...
            public void mo1050onDragk4lQ0M(long delta) {
                ...
                if (it != null) {
                    ...
                    if (it.isAttached() && SelectionRegistrarKt.hasSelection(selectionRegistrar, j)) {
                        this.dragTotalDistance = Offset.m3926plusMKHz9U(this.dragTotalDistance, delta);
                        long newPosition = Offset.m3926plusMKHz9U(this.lastPosition, this.dragTotalDistance);
                        boolean consumed = selectionRegistrar.mo1375notifySelectionUpdatenjBpvok(it, newPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getWord(), true);
                        if (consumed) {
        ...
        return SelectionGesturesKt.selectionGestureInput(Modifier.INSTANCE, new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$mouseSelectionObserver$1
            ...
            public boolean mo1260onExtendk4lQ0M(long downPosition) {
                ...
                boolean consumed = selectionRegistrar.mo1375notifySelectionUpdatenjBpvok(layoutCoordinates, downPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone(), false);
                if (consumed) {
            ...
            public boolean mo1261onExtendDragk4lQ0M(long dragPosition) {
                ...
                if (layoutCoordinates != null) {
                    ...
                    boolean consumed = selectionRegistrar.mo1375notifySelectionUpdatenjBpvok(layoutCoordinates, dragPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone(), false);
                    if (consumed) {
            ...
            public boolean mo1262onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
                ...
                selectionRegistrar.mo1376notifySelectionUpdateStartubNVwUQ(it, downPosition, adjustment, false);
                this.lastPosition = downPosition;
                return SelectionRegistrarKt.hasSelection(selectionRegistrar, j);
            }
            ...
            public boolean mo1259onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                ...
                if (it != null) {
                    ...
                    boolean consumed = selectionRegistrar.mo1375notifySelectionUpdatenjBpvok(it, dragPosition, this.lastPosition, false, adjustment, false);
                    if (consumed) {
                        this.lastPosition = dragPosition;
                        return true;
                    }
