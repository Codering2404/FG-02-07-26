...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        return (it == null || TextOverflow.m6534equalsimpl0(it.getLayoutInput().getOverflow(), TextOverflow.INSTANCE.m6543getVisiblegIe3tQ8()) || !it.getHasVisualOverflow()) ? false : true;
    }
