...
public final class InlineDensity {
    ...
    private static final long Unspecified = m1275constructorimpl(Float.NaN, Float.NaN);
    private final long packedValue;

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InlineDensity m1274boximpl(long j) {
        return new InlineDensity(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static long m1276constructorimpl(long j) {
        return j;
    }
    ...
    public static int m1282hashCodeimpl(long j) {
    ...
    public int hashCode() {
        return m1282hashCodeimpl(this.packedValue);
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m1275constructorimpl(float density, float fontScale) {
        long v1$iv = Float.floatToRawIntBits(density);
        long v2$iv = Float.floatToRawIntBits(fontScale);
        return m1276constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m1277constructorimpl(Density density) {
        return m1275constructorimpl(density.getDensity(), density.getFontScale());
    }

    /* JADX INFO: renamed from: getDensity-impl, reason: not valid java name */
    public static final float m1280getDensityimpl(long arg0) {
    ...
    public static final float m1281getFontScaleimpl(long arg0) {
        int bits$iv$iv = (int) (4294967295L & arg0);
        return Float.intBitsToFloat(bits$iv$iv);
    }

    public String toString() {
        return m1283toStringimpl(this.packedValue);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1283toStringimpl(long arg0) {
        return "InlineDensity(density=" + m1280getDensityimpl(arg0) + ", fontScale=" + m1281getFontScaleimpl(arg0) + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m1285getUnspecifiedL26CHvs() {
