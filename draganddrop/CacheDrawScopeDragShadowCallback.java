...
final class CacheDrawScopeDragShadowCallback {
    ...
    public final DrawResult cachePicture(CacheDrawScope scope) {
        ...
        final int width = (int) Size.m3990getWidthimpl(scope.m3811getSizeNHjbRc());
        final int height = (int) Size.m3987getHeightimpl(scope.m3811getSizeNHjbRc());
        return scope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.draganddrop.CacheDrawScopeDragShadowCallback$cachePicture$1$1
            ...
            public final void invoke2(ContentDrawScope $this$onDrawWithContent) {
                ...
                long size$iv = $this$onDrawWithContent.mo4712getSizeNHjbRc();
                ...
                long prevSize$iv = $this$draw_u2dymL40Pk_u24default$iv.getDrawContext().mo4633getSizeNHjbRc();
                ...
                $this$draw_ymL40Pk_u24lambda_u247$iv.mo4634setSizeuvyYCjk(size$iv);
                ...
                try {
                    ...
                    $this$draw_ymL40Pk_u24lambda_u248$iv.mo4634setSizeuvyYCjk(prevSize$iv);
                    ...
                    $this$draw_ymL40Pk_u24lambda_u248$iv2.mo4634setSizeuvyYCjk(prevSize$iv);
