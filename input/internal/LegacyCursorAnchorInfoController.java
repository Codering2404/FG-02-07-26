...
public final class LegacyCursorAnchorInfoController {
    ...
    private final float[] matrix = Matrix.m4392constructorimpl$default(null, 1, null);
    ...
    private final void updateCursorAnchorInfo() {
        if (this.inputMethodManager.isActive()) {
            Matrix.m4401resetimpl(this.matrix);
            this.localToScreen.invoke(Matrix.m4390boximpl(this.matrix));
            ...
            Matrix.m4411translateimpl(fArr, f, -rect2.getTop(), 0.0f);
            AndroidMatrixConversions_androidKt.m4032setFromEL8BTi8(this.androidMatrix, this.matrix);
