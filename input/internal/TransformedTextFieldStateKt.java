...
public final class TransformedTextFieldStateKt {
    public static final <R> R getIndexTransformationType(TransformedTextFieldState $this$getIndexTransformationType, int transformedQueryIndex, Function3<? super IndexTransformationType, ? super TextRange, ? super TextRange, ? extends R> function3) {
        ...
        long untransformed = $this$getIndexTransformationType.m1215mapFromTransformedjx7JFs(transformedQueryIndex);
        long retransformed = $this$getIndexTransformationType.m1218mapToTransformedGEjPoXI(untransformed);
        if (TextRange.m6085getCollapsedimpl(untransformed) && TextRange.m6085getCollapsedimpl(retransformed)) {
            type = IndexTransformationType.Untransformed;
        } else if (!TextRange.m6085getCollapsedimpl(untransformed) && !TextRange.m6085getCollapsedimpl(retransformed)) {
        ...
        return function3.invoke(type, TextRange.m6079boximpl(untransformed), TextRange.m6079boximpl(retransformed));
    }
}
