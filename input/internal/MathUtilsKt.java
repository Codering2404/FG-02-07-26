...
public final class MathUtilsKt {
    ...
    public static final int m1163findClosestRect9KIMszo(long $this$findClosestRect_u2d9KIMszo, Rect rect1, Rect rect2) {
        float comparativeDistTo1 = m1162distanceSquaredToClosestCornerFromOutside3MmeM6k($this$findClosestRect_u2d9KIMszo, rect1);
        float comparativeDistTo2 = m1162distanceSquaredToClosestCornerFromOutside3MmeM6k($this$findClosestRect_u2d9KIMszo, rect2);
    ...
    private static final float m1162distanceSquaredToClosestCornerFromOutside3MmeM6k(long $this$distanceSquaredToClosestCornerFromOutside_u2d3MmeM6k, Rect rect) {
        if (SelectionManagerKt.m1366containsInclusiveUv8p0NA(rect, $this$distanceSquaredToClosestCornerFromOutside_u2d3MmeM6k)) {
            return 0.0f;
        }
        float it = Offset.m3920getDistanceSquaredimpl(Offset.m3925minusMKHz9U(rect.m3956getTopLeftF1C5BW0(), $this$distanceSquaredToClosestCornerFromOutside_u2d3MmeM6k));
        float distance = it < Float.MAX_VALUE ? it : Float.MAX_VALUE;
        float it2 = Offset.m3920getDistanceSquaredimpl(Offset.m3925minusMKHz9U(rect.m3957getTopRightF1C5BW0(), $this$distanceSquaredToClosestCornerFromOutside_u2d3MmeM6k));
        if (it2 < distance) {
            distance = it2;
        }
        float it3 = Offset.m3920getDistanceSquaredimpl(Offset.m3925minusMKHz9U(rect.m3949getBottomLeftF1C5BW0(), $this$distanceSquaredToClosestCornerFromOutside_u2d3MmeM6k));
        if (it3 < distance) {
            distance = it3;
        }
        float it4 = Offset.m3920getDistanceSquaredimpl(Offset.m3925minusMKHz9U(rect.m3950getBottomRightF1C5BW0(), $this$distanceSquaredToClosestCornerFromOutside_u2d3MmeM6k));
