...
public final class UndoManager<T> {
    ...
    /* JADX INFO: compiled from: UndoManager.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J7\u0010\u0003\u001a\u0014\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00060\u0005\u0012\u0004\u0012\u00020\u00010\u0004\"\u0006\b\u0001\u0010\u0006\u0018\u00012\u0012\u0010\u0007\u001a\u000e\u0012\u0004\u0012\u0002H\u0006\u0012\u0004\u0012\u00020\u00010\u0004H\u0086\b¨\u0006\b"}, d2 = {"Landroidx/compose/foundation/text/input/internal/undo/UndoManager$Companion;", "", "()V", "createSaver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/foundation/text/input/internal/undo/UndoManager;", RequestConfiguration.MAX_AD_CONTENT_RATING_T, "itemSaver", "foundation_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
        ...
        public final /* synthetic */ <T> Saver<UndoManager<T>, Object> createSaver(final Saver<T, Object> itemSaver) {
            ...
            return new Saver<UndoManager<T>, Object>() { // from class: androidx.compose.foundation.text.input.internal.undo.UndoManager$Companion$createSaver$1
                ...
                public Object save(SaverScope $this$save, UndoManager<T> undoManager) {
                    ...
                    $this$save_u24lambda_u244.add(Integer.valueOf(((UndoManager) undoManager).capacity));
                    $this$save_u24lambda_u244.add(Integer.valueOf(((UndoManager) undoManager).undoStack.size()));
                    $this$save_u24lambda_u244.add(Integer.valueOf(((UndoManager) undoManager).redoStack.size()));
                    List $this$fastForEach$iv = ((UndoManager) undoManager).undoStack;
                    int size = $this$fastForEach$iv.size();
                    for (int index$iv = 0; index$iv < size; index$iv++) {
                        $this$save_u24lambda_u244.add($this$save_u24lambda_u244_u24lambda_u241_u24lambda_u240.save($this$save, $this$fastForEach$iv.get(index$iv)));
                    }
                    List $this$fastForEach$iv2 = ((UndoManager) undoManager).redoStack;
                    int size2 = $this$fastForEach$iv2.size();
                    for (int index$iv2 = 0; index$iv2 < size2; index$iv2++) {
                        $this$save_u24lambda_u244.add($this$save_u24lambda_u244_u24lambda_u241_u24lambda_u240.save($this$save, $this$fastForEach$iv2.get(index$iv2)));
                    }
                ...
                public UndoManager<T> restore(Object value) {
                    ...
                    while (i < undoSize + 3) {
                        ...
                        $this$restore_u24lambda_u245.add(tRestore);
                        i++;
                    }
                    ...
                    while (i < undoSize + redoSize + 3) {
                        ...
                        $this$restore_u24lambda_u246.add(tRestore2);
                        i++;
                    }
