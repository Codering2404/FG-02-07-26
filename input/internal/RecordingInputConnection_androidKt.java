...
public final class RecordingInputConnection_androidKt {
    ...
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m6089getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m6088getMaximpl(textFieldValue.getSelection());
