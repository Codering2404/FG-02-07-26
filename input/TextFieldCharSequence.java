...
public final class TextFieldCharSequence implements CharSequence {
    ...
    private TextFieldCharSequence(CharSequence text, long selection, TextRange composition, Pair<TextHighlightType, TextRange> pair) {
        ...
        this.selection = TextRangeKt.m6097coerceIn8ffj60Q(selection, 0, text.length());
        this.composition = composition != null ? TextRange.m6079boximpl(TextRangeKt.m6097coerceIn8ffj60Q(composition.getPackedValue(), 0, text.length())) : null;
        this.highlight = pair != null ? Pair.copy$default(pair, null, TextRange.m6079boximpl(TextRangeKt.m6097coerceIn8ffj60Q(pair.getSecond().getPackedValue(), 0, text.length())), 1, null) : null;
    }
    ...
    public /* synthetic */ TextFieldCharSequence(CharSequence charSequence, long j, TextRange textRange, Pair pair, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : charSequence, (i & 2) != 0 ? TextRange.INSTANCE.m6096getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (i & 8) != 0 ? null : pair, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (TextRange.m6084equalsimpl0(this.selection, ((TextFieldCharSequence) other).selection) && Intrinsics.areEqual(this.composition, ((TextFieldCharSequence) other).composition) && Intrinsics.areEqual(this.highlight, ((TextFieldCharSequence) other).highlight) && contentEquals(((TextFieldCharSequence) other).text)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result2 = ((result * 31) + TextRange.m6092hashCodeimpl(this.selection)) * 31;
        TextRange textRange = this.composition;
        int result3 = (result2 + (textRange != null ? TextRange.m6092hashCodeimpl(textRange.getPackedValue()) : 0)) * 31;
