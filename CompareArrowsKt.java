...
public final class CompareArrowsKt {
    ...
    public static final ImageVector getCompareArrows(Icons.AutoMirrored.TwoTone $this$CompareArrows) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(3.99f, 4.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _compareArrows = ImageVector.Builder.m4845addPathoIyEayM$default($this$_get_CompareArrows__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
