...
public final class LongPressTextDragObserverKt {
    public static final Object detectDragGesturesAfterLongPressWithObserver(PointerInputScope $this$detectDragGesturesAfterLongPressWithObserver, final TextDragObserver observer, Continuation<? super Unit> continuation) {
        Object objDetectDragGesturesAfterLongPress = DragGestureDetectorKt.detectDragGesturesAfterLongPress($this$detectDragGesturesAfterLongPressWithObserver, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.LongPressTextDragObserverKt.detectDragGesturesAfterLongPressWithObserver.2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                m1015invokek4lQ0M(offset.getPackedValue());
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
            public final void m1015invokek4lQ0M(long it) {
                observer.mo1051onStartk4lQ0M(it);
            }
            ...
            public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
                m1016invokeUv8p0NA(pointerInputChange, offset.getPackedValue());
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-Uv8p0NA, reason: not valid java name */
            public final void m1016invokeUv8p0NA(PointerInputChange pointerInputChange, long offset) {
                observer.mo1050onDragk4lQ0M(offset);
            }
        }, continuation);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    return BuildersKt__Builders_commonKt.launch$default($this$coroutineScope, null, CoroutineStart.UNDISPATCHED, new C00452(this.$this_detectDownAndDragGesturesWithObserver, this.$observer, null), 1, null);
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
        }
    ...
    static final class C03692 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ TextDragObserver $observer;
        private /* synthetic */ Object L$0;
        Object L$1;
        int label;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03692(TextDragObserver textDragObserver, Continuation<? super C03692> continuation) {
            super(2, continuation);
            this.$observer = textDragObserver;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03692 c03692 = new C03692(this.$observer, continuation);
            c03692.L$0 = obj;
            return c03692;
        }
        ...
        public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super Unit> continuation) {
            return ((C03692) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r19) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.LongPressTextDragObserverKt.C03692.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public static final Object detectPreDragGesturesWithObserver(PointerInputScope $this$detectPreDragGesturesWithObserver, TextDragObserver observer, Continuation<? super Unit> continuation) {
        Object objAwaitEachGesture = ForEachGestureKt.awaitEachGesture($this$detectPreDragGesturesWithObserver, new C03692(observer, null), continuation);
    ...
    public static final Object detectDragGesturesWithObserver(PointerInputScope $this$detectDragGesturesWithObserver, final TextDragObserver observer, Continuation<? super Unit> continuation) {
        Object objDetectDragGestures = DragGestureDetectorKt.detectDragGestures($this$detectDragGesturesWithObserver, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.LongPressTextDragObserverKt.detectDragGesturesWithObserver.2
            ...
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                m1017invokek4lQ0M(offset.getPackedValue());
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
            public final void m1017invokek4lQ0M(long it) {
                observer.mo1051onStartk4lQ0M(it);
            }
            ...
            @Override // kotlin.jvm.functions.Function2
            public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
                m1018invokeUv8p0NA(pointerInputChange, offset.getPackedValue());
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-Uv8p0NA, reason: not valid java name */
            public final void m1018invokeUv8p0NA(PointerInputChange pointerInputChange, long offset) {
                observer.mo1050onDragk4lQ0M(offset);
            }
        }, continuation);
