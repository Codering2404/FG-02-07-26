...
public final class BackgroundKt {
    ...
    public static /* synthetic */ Modifier m228backgroundbw27NRU$default(Modifier modifier, long j, Shape shape, int i, Object obj) {
        if ((i & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m227backgroundbw27NRU(modifier, j, shape);
    }

    /* JADX INFO: renamed from: background-bw27NRU, reason: not valid java name */
    public static final Modifier m227backgroundbw27NRU(Modifier $this$background_u2dbw27NRU, final long color, final Shape shape) {
        float alpha = 1.0f;
        return $this$background_u2dbw27NRU.then(new BackgroundElement(color, null, alpha, shape, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.BackgroundKt$background-bw27NRU$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.setValue(Color.m4152boximpl(color));
                $this$null.getProperties().set("color", Color.m4152boximpl(color));
