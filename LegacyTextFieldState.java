...
public final class LegacyTextFieldState {
    ...
    private final Function1<TextFieldValue, Unit> onValueChange = new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$onValueChange$1
        ...
        public final void invoke2(TextFieldValue it) {
            ...
            this.this$0.m1012setSelectionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6096getZerod9O1mEE());
            this.this$0.m1009setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6096getZerod9O1mEE());
    ...
    private final Function1<ImeAction, Unit> onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$onImeActionPerformed$1
        ...
        public final void m1014invokeKlQnJC8(int imeAction) {
            this.this$0.keyboardActionRunner.m990runActionKlQnJC8(imeAction);
        }
    };
    private final Paint highlightPaint = AndroidPaint_androidKt.Paint();
    private long selectionBackgroundColor = Color.INSTANCE.m4198getUnspecified0d7_KjU();

    /* JADX INFO: renamed from: selectionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState selectionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m6079boximpl(TextRange.INSTANCE.m6096getZerod9O1mEE()), null, 2, null);

    /* JADX INFO: renamed from: deletionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState deletionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m6079boximpl(TextRange.INSTANCE.m6096getZerod9O1mEE()), null, 2, null);
    ...
    public final void m1012setSelectionPreviewHighlightRange5zctL8(long j) {
        ...
        $this$setValue$iv.setValue(TextRange.m6079boximpl(j));
    }
    ...
    public final boolean hasHighlight() {
        return (TextRange.m6085getCollapsedimpl(m1008getSelectionPreviewHighlightRanged9O1mEE()) && TextRange.m6085getCollapsedimpl(m1005getDeletionPreviewHighlightRanged9O1mEE())) ? false : true;
    }
    ...
    public final void m1013updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean softWrap, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long selectionBackgroundColor) {
        ...
        TextDelegate newTextDelegate = TextDelegateKt.m1048updateTextDelegaterm0N8CA$default(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, softWrap, 0, 0, 0, CollectionsKt.emptyList(), 448, null);
