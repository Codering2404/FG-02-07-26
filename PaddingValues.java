...
final class PaddingValues implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        return density.mo359roundToPx0680j_4(this.paddingValues.mo624calculateLeftPaddingu2uoSUM(layoutDirection));
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        return density.mo359roundToPx0680j_4(this.paddingValues.getTop());
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getRight(Density density, LayoutDirection layoutDirection) {
        return density.mo359roundToPx0680j_4(this.paddingValues.mo625calculateRightPaddingu2uoSUM(layoutDirection));
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        return density.mo359roundToPx0680j_4(this.paddingValues.getBottom());
    }

    public String toString() {
        LayoutDirection layoutDirection = LayoutDirection.Ltr;
        float start = this.paddingValues.mo624calculateLeftPaddingu2uoSUM(layoutDirection);
        float top = this.paddingValues.getTop();
        float end = this.paddingValues.mo625calculateRightPaddingu2uoSUM(layoutDirection);
        float bottom = this.paddingValues.getBottom();
        return "PaddingValues(" + ((Object) Dp.m6636toStringimpl(start)) + ", " + ((Object) Dp.m6636toStringimpl(top)) + ", " + ((Object) Dp.m6636toStringimpl(end)) + ", " + ((Object) Dp.m6636toStringimpl(bottom)) + ')';
    }
