...
public final class KeyboardOptions {
    ...
    private static final KeyboardOptions SecureTextField = new KeyboardOptions(0, (Boolean) false, KeyboardType.INSTANCE.m6327getPasswordPjHm6EE(), 0, (PlatformImeOptions) (null == true ? 1 : 0), (Boolean) (null == true ? 1 : 0), (LocaleList) null, 121, (DefaultConstructorMarker) null);
    ...
    public /* synthetic */ KeyboardOptions(int i, Boolean bool, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool2, LocaleList localeList, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        int iM6303getUnspecifiedIUNYP9k = (i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m6303getUnspecifiedIUNYP9k() : i;
        Boolean bool3 = (i4 & 2) != 0 ? null : bool;
        int iM6330getUnspecifiedPjHm6EE = (i4 & 4) != 0 ? KeyboardType.INSTANCE.m6330getUnspecifiedPjHm6EE() : i2;
        int iM6276getUnspecifiedeUduSuo = (i4 & 8) != 0 ? ImeAction.INSTANCE.m6276getUnspecifiedeUduSuo() : i3;
        PlatformImeOptions platformImeOptions2 = (i4 & 16) != 0 ? null : platformImeOptions;
        Boolean bool4 = (i4 & 32) != 0 ? null : bool2;
        this(iM6303getUnspecifiedIUNYP9k, bool3, iM6330getUnspecifiedPjHm6EE, iM6276getUnspecifiedeUduSuo, platformImeOptions2, bool4, (i4 & 64) == 0 ? localeList : null, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool, LocaleList localeList, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m6303getUnspecifiedIUNYP9k() : i, z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m6330getUnspecifiedPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m6276getUnspecifiedeUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (i4 & 32) != 0 ? null : bool, (i4 & 64) != 0 ? null : localeList, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m6303getUnspecifiedIUNYP9k() : i, (i4 & 2) != 0 ? Default.getAutoCorrectOrDefault() : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m6330getUnspecifiedPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m6268getDefaulteUduSuo() : i3, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m6301getNoneIUNYP9k() : i, (i4 & 2) != 0 ? Default.getAutoCorrectOrDefault() : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m6329getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m6268getDefaulteUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (DefaultConstructorMarker) null);
    }
    ...
    private final int m995getCapitalizationOrDefaultIUNYP9k() {
        KeyboardCapitalization keyboardCapitalizationM6288boximpl = KeyboardCapitalization.m6288boximpl(this.capitalization);
        int it = keyboardCapitalizationM6288boximpl.getValue();
        if (KeyboardCapitalization.m6291equalsimpl0(it, KeyboardCapitalization.INSTANCE.m6303getUnspecifiedIUNYP9k())) {
            keyboardCapitalizationM6288boximpl = null;
        }
        return keyboardCapitalizationM6288boximpl != null ? keyboardCapitalizationM6288boximpl.getValue() : KeyboardCapitalization.INSTANCE.m6301getNoneIUNYP9k();
    }

    /* JADX INFO: renamed from: getKeyboardTypeOrDefault-PjHm6EE, reason: not valid java name */
    private final int m996getKeyboardTypeOrDefaultPjHm6EE() {
        KeyboardType keyboardTypeM6305boximpl = KeyboardType.m6305boximpl(this.keyboardType);
        int it = keyboardTypeM6305boximpl.getValue();
        if (KeyboardType.m6308equalsimpl0(it, KeyboardType.INSTANCE.m6330getUnspecifiedPjHm6EE())) {
            keyboardTypeM6305boximpl = null;
        }
        return keyboardTypeM6305boximpl != null ? keyboardTypeM6305boximpl.getValue() : KeyboardType.INSTANCE.m6329getTextPjHm6EE();
    }

    /* JADX INFO: renamed from: getImeActionOrDefault-eUduSuo$foundation_release, reason: not valid java name */
    public final int m1003getImeActionOrDefaulteUduSuo$foundation_release() {
        ImeAction imeActionM6252boximpl = ImeAction.m6252boximpl(this.imeAction);
        int it = imeActionM6252boximpl.getValue();
        if (ImeAction.m6255equalsimpl0(it, ImeAction.INSTANCE.m6276getUnspecifiedeUduSuo())) {
            imeActionM6252boximpl = null;
        }
        return imeActionM6252boximpl != null ? imeActionM6252boximpl.getValue() : ImeAction.INSTANCE.m6268getDefaulteUduSuo();
    }
    ...
    private final boolean isCompletelyUnspecified() {
        return KeyboardCapitalization.m6291equalsimpl0(this.capitalization, KeyboardCapitalization.INSTANCE.m6303getUnspecifiedIUNYP9k()) && this.autoCorrectEnabled == null && KeyboardType.m6308equalsimpl0(this.keyboardType, KeyboardType.INSTANCE.m6330getUnspecifiedPjHm6EE()) && ImeAction.m6255equalsimpl0(this.imeAction, ImeAction.INSTANCE.m6276getUnspecifiedeUduSuo()) && this.platformImeOptions == null && this.showKeyboardOnFocus == null && this.hintLocales == null;
    }
    ...
    public final ImeOptions toImeOptions$foundation_release(boolean singleLine) {
        return new ImeOptions(singleLine, m995getCapitalizationOrDefaultIUNYP9k(), getAutoCorrectOrDefault(), m996getKeyboardTypeOrDefaultPjHm6EE(), m1003getImeActionOrDefaulteUduSuo$foundation_release(), this.platformImeOptions, getHintLocalesOrDefault(), (DefaultConstructorMarker) null);
    }

    /* JADX INFO: renamed from: copy-INvB4aQ$default, reason: not valid java name */
    public static /* synthetic */ KeyboardOptions m992copyINvB4aQ$default(KeyboardOptions keyboardOptions, int i, Boolean bool, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool2, LocaleList localeList, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return keyboardOptions.m998copyINvB4aQ(i, bool, i2, i3, platformImeOptions, bool2, (i4 & 64) != 0 ? null : localeList);
    }

    /* JADX INFO: renamed from: copy-INvB4aQ, reason: not valid java name */
    public final KeyboardOptions m998copyINvB4aQ(int capitalization, Boolean autoCorrectEnabled, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions, Boolean showKeyboardOnFocus, LocaleList hintLocales) {
    ...
    /* JADX INFO: renamed from: copy-INvB4aQ$default, reason: not valid java name */
    public static /* synthetic */ KeyboardOptions m993copyINvB4aQ$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool, LocaleList localeList, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = keyboardOptions.capitalization;
        }
        if ((i4 & 2) != 0) {
        ...
        return keyboardOptions.m999copyINvB4aQ(i, z, i2, i3, platformImeOptions, bool, localeList2);
    }
    ...
    /* JADX INFO: renamed from: copy-INvB4aQ, reason: not valid java name */
    public final /* synthetic */ KeyboardOptions m999copyINvB4aQ(int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions, Boolean showKeyboardOnFocus, LocaleList hintLocales) {
    ...
    public static /* synthetic */ KeyboardOptions m994copyij11fho$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = keyboardOptions.capitalization;
        }
        if ((i4 & 2) != 0) {
        ...
        return keyboardOptions.m1000copyij11fho(i, z, i2, i3, (i4 & 16) != 0 ? keyboardOptions.platformImeOptions : platformImeOptions);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Maintained for binary compatibility")
    /* JADX INFO: renamed from: copy-ij11fho, reason: not valid java name */
    public final /* synthetic */ KeyboardOptions m1000copyij11fho(int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions) {
    ...
    public static /* synthetic */ KeyboardOptions m991copy3m2b7yw$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = keyboardOptions.capitalization;
        }
        if ((i4 & 2) != 0) {
        ...
        return keyboardOptions.m997copy3m2b7yw(i, z, i2, i3);
    }
    ...
    public final /* synthetic */ KeyboardOptions m997copy3m2b7yw(int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof KeyboardOptions) && KeyboardCapitalization.m6291equalsimpl0(this.capitalization, ((KeyboardOptions) other).capitalization) && Intrinsics.areEqual(this.autoCorrectEnabled, ((KeyboardOptions) other).autoCorrectEnabled) && KeyboardType.m6308equalsimpl0(this.keyboardType, ((KeyboardOptions) other).keyboardType) && ImeAction.m6255equalsimpl0(this.imeAction, ((KeyboardOptions) other).imeAction) && Intrinsics.areEqual(this.platformImeOptions, ((KeyboardOptions) other).platformImeOptions) && Intrinsics.areEqual(this.showKeyboardOnFocus, ((KeyboardOptions) other).showKeyboardOnFocus) && Intrinsics.areEqual(this.hintLocales, ((KeyboardOptions) other).hintLocales);
    }

    public int hashCode() {
        int result = KeyboardCapitalization.m6292hashCodeimpl(this.capitalization);
        int i = result * 31;
        Boolean bool = this.autoCorrectEnabled;
        int result2 = i + (bool != null ? bool.hashCode() : 0);
        int result3 = ((((result2 * 31) + KeyboardType.m6309hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m6256hashCodeimpl(this.imeAction)) * 31;
    ...
    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m6293toStringimpl(this.capitalization)) + ", autoCorrectEnabled=" + this.autoCorrectEnabled + ", keyboardType=" + ((Object) KeyboardType.m6310toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m6257toStringimpl(this.imeAction)) + ", platformImeOptions=" + this.platformImeOptions + "showKeyboardOnFocus=" + this.showKeyboardOnFocus + ", hintLocales=" + this.hintLocales + ')';
    }
    ...
    public final KeyboardOptions fillUnspecifiedValuesWith$foundation_release(KeyboardOptions other) {
        ...
        int value = keyboardCapitalizationM6288boximpl != null ? keyboardCapitalizationM6288boximpl.getValue() : other.capitalization;
        ...
        KeyboardType keyboardTypeM6305boximpl = KeyboardType.m6305boximpl(this.keyboardType);
        int it2 = keyboardTypeM6305boximpl.getValue();
        if (KeyboardType.m6308equalsimpl0(it2, KeyboardType.INSTANCE.m6330getUnspecifiedPjHm6EE())) {
            keyboardTypeM6305boximpl = null;
        }
        int value2 = keyboardTypeM6305boximpl != null ? keyboardTypeM6305boximpl.getValue() : other.keyboardType;
        ImeAction imeActionM6252boximpl = ImeAction.m6252boximpl(this.imeAction);
        int it3 = imeActionM6252boximpl.getValue();
        ImeAction imeAction = ImeAction.m6255equalsimpl0(it3, ImeAction.INSTANCE.m6276getUnspecifiedeUduSuo()) ? null : imeActionM6252boximpl;
