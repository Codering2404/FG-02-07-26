...
public final class OffsetKt {
    ...
    public static final Modifier m633offsetVpY3zN4(Modifier $this$offset_u2dVpY3zN4, final float x, final float y) {
        return $this$offset_u2dVpY3zN4.then(new OffsetModifierElement(x, y, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.OffsetKt.offset.1
            ...
            public final void invoke2(InspectorInfo $this$$receiver) {
                ...
                $this$$receiver.getProperties().set("x", Dp.m6623boximpl(x));
                $this$$receiver.getProperties().set("y", Dp.m6623boximpl(y));
            }
        }, null));
    }
    ...
    public static final Modifier m631absoluteOffsetVpY3zN4(Modifier $this$absoluteOffset_u2dVpY3zN4, final float x, final float y) {
