...
final class Insets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        return density.mo359roundToPx0680j_4(this.left);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        return density.mo359roundToPx0680j_4(this.top);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getRight(Density density, LayoutDirection layoutDirection) {
        return density.mo359roundToPx0680j_4(this.right);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        return density.mo359roundToPx0680j_4(this.bottom);
    }

    public String toString() {
        return "Insets(left=" + ((Object) Dp.m6636toStringimpl(this.left)) + ", top=" + ((Object) Dp.m6636toStringimpl(this.top)) + ", right=" + ((Object) Dp.m6636toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m6636toStringimpl(this.bottom)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof Insets) {
            return Dp.m6630equalsimpl0(this.left, ((Insets) other).left) && Dp.m6630equalsimpl0(this.top, ((Insets) other).top) && Dp.m6630equalsimpl0(this.right, ((Insets) other).right) && Dp.m6630equalsimpl0(this.bottom, ((Insets) other).bottom);
        }
        return false;
    }

    public int hashCode() {
        int result = Dp.m6631hashCodeimpl(this.left);
        return (((((result * 31) + Dp.m6631hashCodeimpl(this.top)) * 31) + Dp.m6631hashCodeimpl(this.right)) * 31) + Dp.m6631hashCodeimpl(this.bottom);
    }
}
