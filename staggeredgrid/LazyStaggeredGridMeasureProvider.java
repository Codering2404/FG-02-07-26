...
public abstract class LazyStaggeredGridMeasureProvider implements LazyLayoutMeasuredItemProvider<LazyStaggeredGridMeasuredItem> {
    ...
    public abstract LazyStaggeredGridMeasuredItem mo881createItempitSLOA(int index, int lane, int span, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private final long m887childConstraintsJhjzzOo(int slot, int span) {
        int start;
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m6590fixedWidthOenEA2s(start);
        }
        return Constraints.INSTANCE.m6589fixedHeightOenEA2s(start);
    }

    /* JADX INFO: renamed from: getAndMeasure-jy6DScQ, reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m888getAndMeasurejy6DScQ(int index, long span) {
        ...
        long constraints = m887childConstraintsJhjzzOo(spanStart, spanSize);
        return mo881createItempitSLOA(index, spanStart, spanSize, key, contentType, this.measureScope.mo844measure0kLqBqw(index, constraints), constraints);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasuredItemProvider
    /* JADX INFO: renamed from: getAndMeasure--hBUhpc */
    public LazyStaggeredGridMeasuredItem mo787getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        Object key = this.itemProvider.getKey(index);
        Object contentType = this.itemProvider.getContentType(index);
        return mo881createItempitSLOA(index, lane, span, key, contentType, this.measureScope.mo844measure0kLqBqw(index, constraints), constraints);
    }
