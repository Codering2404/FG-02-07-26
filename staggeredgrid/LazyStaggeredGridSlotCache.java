...
final class LazyStaggeredGridSlotCache implements LazyGridStaggeredGridSlotsProvider {
    ...
    public LazyStaggeredGridSlots mo867invoke0kLqBqw(Density density, long constraints) {
        if (this.cachedSizes != null && Constraints.m6571equalsimpl0(this.cachedConstraints, constraints)) {
        ...
        LazyStaggeredGridSlots lazyStaggeredGridSlotsInvoke = this.calculation.invoke(density, Constraints.m6566boximpl(constraints));
