...
public final class LazyStaggeredGridMeasuredItem implements LazyStaggeredGridItemInfo, LazyLayoutMeasuredItem {
    ...
    private LazyStaggeredGridMeasuredItem(int index, Object key, List<? extends Placeable> list, boolean isVertical, int spacing, int lane, int span, int beforeContentPadding, int afterContentPadding, Object contentType, LazyLayoutItemAnimator<LazyStaggeredGridMeasuredItem> lazyLayoutItemAnimator, long constraints) {
        ...
        if (!list3.isEmpty()) {
            ...
            Integer numValueOf3 = Integer.valueOf(getIsVertical() ? it.getWidth() : it.getHeight());
            int i$iv2 = 1;
            int lastIndex2 = CollectionsKt.getLastIndex(list3);
            if (1 <= lastIndex2) {
                while (true) {
                    Placeable it2 = list3.get(i$iv2);
                    Integer numValueOf4 = Integer.valueOf(getIsVertical() ? it2.getWidth() : it2.getHeight());
        ...
        this.offset = IntOffset.INSTANCE.m6763getZeronOccac();
    }
    ...
    public final int getMainAxisOffset() {
        return !getIsVertical() ? IntOffset.m6753getXimpl(getOffset()) : IntOffset.m6754getYimpl(getOffset());
    }
    ...
    public final void place(Placeable.PlacementScope scope, LazyStaggeredGridMeasureContext context) {
        ...
        while (index$iv < size) {
            ...
            if (animation != null) {
                i = i3;
                i2 = i4;
                long animatedOffset = IntOffset.m6757plusqkQi6aY(offset, animation.m832getPlacementDeltanOccac());
                $this$place_u24lambda_u246_u24lambda_u245 = $this$place_u24lambda_u246_u24lambda_u2452;
                if ((m890getMainAxisgyyYBs(offset) <= minOffset && m890getMainAxisgyyYBs(animatedOffset) <= minOffset) || (m890getMainAxisgyyYBs(offset) >= maxOffset && m890getMainAxisgyyYBs(animatedOffset) >= maxOffset)) {
            ...
            if ($this$place_u24lambda_u2462.getReverseLayout()) {
                ...
                if (getIsVertical()) {
                    layer2 = layer;
                    height = IntOffset.m6753getXimpl($this$copy_u2d4Tuh3kE$iv);
                } else {
                    int mainAxisOffset = IntOffset.m6753getXimpl($this$copy_u2d4Tuh3kE$iv);
                    layer2 = layer;
                    height = (this.mainAxisLayoutSize - mainAxisOffset) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                }
                if (getIsVertical()) {
                    int mainAxisOffset2 = IntOffset.m6754getYimpl($this$copy_u2d4Tuh3kE$iv);
                    iM6754getYimpl = (this.mainAxisLayoutSize - mainAxisOffset2) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                } else {
                    iM6754getYimpl = IntOffset.m6754getYimpl($this$copy_u2d4Tuh3kE$iv);
                }
                offset = IntOffsetKt.IntOffset(height, iM6754getYimpl);
            } else {
                layer2 = layer;
            }
            long offset2 = IntOffset.m6757plusqkQi6aY(offset, $this$place_u24lambda_u2462.getContentOffset());
            if (animation != null) {
                animation.m834setFinalOffsetgyyYBs(offset2);
            }
            if (layer2 != null) {
                $this$place_u24lambda_u246_u24lambda_u2452 = $this$place_u24lambda_u246_u24lambda_u245;
                Placeable.PlacementScope.m5557placeRelativeWithLayeraW9wM$default($this$place_u24lambda_u246_u24lambda_u2452, placeable, offset2, layer2, 0.0f, 4, (Object) null);
            } else {
                $this$place_u24lambda_u246_u24lambda_u2452 = $this$place_u24lambda_u246_u24lambda_u245;
                Placeable.PlacementScope.m5556placeRelativeWithLayeraW9wM$default($this$place_u24lambda_u246_u24lambda_u2452, placeable, offset2, 0.0f, (Function1) null, 6, (Object) null);
            }
            index$iv++;
    ...
    public final void applyScrollDelta(int delta) {
        ...
        if (getIsVertical()) {
            it = IntOffset.m6753getXimpl($this$copy_u2d4Tuh3kE$iv);
        } else {
            int it3 = IntOffset.m6753getXimpl($this$copy_u2d4Tuh3kE$iv);
            it = it3 + delta;
        }
        if (getIsVertical()) {
            int it4 = IntOffset.m6754getYimpl($this$copy_u2d4Tuh3kE$iv);
            it2 = it4 + delta;
        } else {
            it2 = IntOffset.m6754getYimpl($this$copy_u2d4Tuh3kE$iv);
        }
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            if (animation != null) {
                ...
                if (getIsVertical()) {
                    iIntValue = IntOffset.m6753getXimpl($this$copy_u2d4Tuh3kE$iv2);
                } else {
                    int mainAxis2 = IntOffset.m6753getXimpl($this$copy_u2d4Tuh3kE$iv2);
                    iIntValue = Integer.valueOf(mainAxis2 + delta).intValue();
                }
                if (getIsVertical()) {
                    int mainAxis3 = IntOffset.m6754getYimpl($this$copy_u2d4Tuh3kE$iv2);
                    mainAxis = mainAxis3 + delta;
                } else {
                    mainAxis = IntOffset.m6754getYimpl($this$copy_u2d4Tuh3kE$iv2);
                }
                animation.m836setRawOffsetgyyYBs(IntOffsetKt.IntOffset(iIntValue, mainAxis));
            }
        }
    }

    /* JADX INFO: renamed from: getMainAxis--gyyYBs, reason: not valid java name */
    private final int m890getMainAxisgyyYBs(long $this$mainAxis) {
        return getIsVertical() ? IntOffset.m6754getYimpl($this$mainAxis) : IntOffset.m6753getXimpl($this$mainAxis);
    }
    ...
    private final long m889copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {
        return IntOffsetKt.IntOffset(getIsVertical() ? IntOffset.m6753getXimpl($this$copy_u2d4Tuh3kE) : function1.invoke(Integer.valueOf(IntOffset.m6753getXimpl($this$copy_u2d4Tuh3kE))).intValue(), getIsVertical() ? function1.invoke(Integer.valueOf(IntOffset.m6754getYimpl($this$copy_u2d4Tuh3kE))).intValue() : IntOffset.m6754getYimpl($this$copy_u2d4Tuh3kE));
    }
