...
final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m637setX0680j_4(float f) {
        this.x = f;
    }
    ...
    public final void m638setY0680j_4(float f) {
        this.y = f;
    }
    ...
    public MeasureResult mo85measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        final Placeable placeable = measurable.mo5490measureBRTryo0(constraints);
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                if (rtlAware) {
                    Placeable.PlacementScope.placeRelative$default($this$layout, placeable2, $this$measure_u2d3p2s80s.mo359roundToPx0680j_4(this.this$0.getX()), $this$measure_u2d3p2s80s.mo359roundToPx0680j_4(this.this$0.getY()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default($this$layout, placeable2, $this$measure_u2d3p2s80s.mo359roundToPx0680j_4(this.this$0.getX()), $this$measure_u2d3p2s80s.mo359roundToPx0680j_4(this.this$0.getY()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
