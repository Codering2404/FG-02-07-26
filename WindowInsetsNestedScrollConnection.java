...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo749onPreScrollOzD1aCk(long available, int source) {
        return m747scroll8S9VItk(available, this.sideCalculator.hideMotion(Offset.m3921getXimpl(available), Offset.m3922getYimpl(available)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostScroll-DzOQY0M */
    public long mo475onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m747scroll8S9VItk(available, this.sideCalculator.showMotion(Offset.m3921getXimpl(available), Offset.m3922getYimpl(available)));
    }
    ...
    public Object mo748onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
        return m746flinghuYlsQE(available, this.sideCalculator.hideMotion(Velocity.m6862getXimpl(available), Velocity.m6863getYimpl(available)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostFling-RZ2iAVY */
    public Object mo474onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
        return m746flinghuYlsQE(available, this.sideCalculator.showMotion(Velocity.m6862getXimpl(available), Velocity.m6863getYimpl(available)), true, continuation);
    }
    ...
    */
    public final java.lang.Object m746flinghuYlsQE(long r24, float r26, boolean r27, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r28) {
        /*
            Method dump skipped, instruction units count: 440
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.layout.WindowInsetsNestedScrollConnection.m746flinghuYlsQE(long, float, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }
