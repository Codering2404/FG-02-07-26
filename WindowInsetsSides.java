...
public final class WindowInsetsSides {
    ...
    private static final int AllowLeftInLtr = m751constructorimpl(8);
    private static final int AllowRightInLtr = m751constructorimpl(4);
    private static final int AllowLeftInRtl = m751constructorimpl(2);
    private static final int AllowRightInRtl = m751constructorimpl(1);
    private static final int Start = m756plusgK_yJZ4(AllowLeftInLtr, AllowRightInRtl);
    private static final int End = m756plusgK_yJZ4(AllowRightInLtr, AllowLeftInRtl);
    private static final int Top = m751constructorimpl(16);
    private static final int Bottom = m751constructorimpl(32);
    private static final int Left = m756plusgK_yJZ4(AllowLeftInLtr, AllowLeftInRtl);
    private static final int Right = m756plusgK_yJZ4(AllowRightInLtr, AllowRightInRtl);
    private static final int Horizontal = m756plusgK_yJZ4(Left, Right);
    private static final int Vertical = m756plusgK_yJZ4(Top, Bottom);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ WindowInsetsSides m750boximpl(int i) {
        return new WindowInsetsSides(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m751constructorimpl(int i) {
        return i;
    }
    ...
    public static final int m756plusgK_yJZ4(int arg0, int sides) {
        return m751constructorimpl(arg0 | sides);
    }

    /* JADX INFO: renamed from: hasAny-bkgdKaI$foundation_layout_release, reason: not valid java name */
    public static final boolean m754hasAnybkgdKaI$foundation_layout_release(int arg0, int sides) {
        return (arg0 & sides) != 0;
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m757toStringimpl(int arg0) {
        return "WindowInsetsSides(" + m758valueToStringimpl(arg0) + ')';
    }
    ...
    private static final String m758valueToStringimpl(int arg0) {
