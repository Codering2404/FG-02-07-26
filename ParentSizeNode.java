...
final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo85measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        long childConstraints = ConstraintsKt.Constraints(width != Integer.MAX_VALUE ? width : Constraints.m6580getMinWidthimpl(constraints), width != Integer.MAX_VALUE ? width : Constraints.m6578getMaxWidthimpl(constraints), height != Integer.MAX_VALUE ? height : Constraints.m6579getMinHeightimpl(constraints), height != Integer.MAX_VALUE ? height : Constraints.m6577getMaxHeightimpl(constraints));
