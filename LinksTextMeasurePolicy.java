...
final class LinksTextMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo33measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, final List<? extends Measurable> list, long constraints) {
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, Constraints.m6578getMaxWidthimpl(constraints), Constraints.m6577getMaxHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.LinksTextMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                List linksToPlace = BasicTextKt.measureWithTextRangeMeasureConstraints(list, this.shouldMeasureLinks);
                ...
                for (int index$iv = 0; index$iv < size; index$iv++) {
                    ...
                    Placeable.PlacementScope.m5554place70tqf50$default($this$layout, placeable, measureResult != null ? ((IntOffset) measureResult.invoke()).getPackedValue() : IntOffset.INSTANCE.m6763getZeronOccac(), 0.0f, 2, null);
                }
            }
        }, 4, null);
    }
