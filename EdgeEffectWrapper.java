...
final class EdgeEffectWrapper {
    ...
    private long size = IntSize.INSTANCE.m6800getZeroYbymL2g();
    ...
    private final EdgeEffect createEdgeEffect() {
        ...
        if (!IntSize.m6793equalsimpl0(this.size, IntSize.INSTANCE.m6800getZeroYbymL2g())) {
            $this$createEdgeEffect_u24lambda_u248.setSize(IntSize.m6795getWidthimpl(this.size), IntSize.m6794getHeightimpl(this.size));
        }
    ...
    public final void m283setSizeozmzZPI(long size) {
        ...
        EdgeEffect edgeEffect = this.topEffect;
        if (edgeEffect != null) {
            edgeEffect.setSize(IntSize.m6795getWidthimpl(size), IntSize.m6794getHeightimpl(size));
        }
        EdgeEffect edgeEffect2 = this.bottomEffect;
        if (edgeEffect2 != null) {
            edgeEffect2.setSize(IntSize.m6795getWidthimpl(size), IntSize.m6794getHeightimpl(size));
        }
        EdgeEffect edgeEffect3 = this.leftEffect;
        if (edgeEffect3 != null) {
            edgeEffect3.setSize(IntSize.m6794getHeightimpl(size), IntSize.m6795getWidthimpl(size));
        }
        EdgeEffect edgeEffect4 = this.rightEffect;
        if (edgeEffect4 != null) {
            edgeEffect4.setSize(IntSize.m6794getHeightimpl(size), IntSize.m6795getWidthimpl(size));
        }
        EdgeEffect edgeEffect5 = this.topEffectNegation;
        if (edgeEffect5 != null) {
            edgeEffect5.setSize(IntSize.m6795getWidthimpl(size), IntSize.m6794getHeightimpl(size));
        }
        EdgeEffect edgeEffect6 = this.bottomEffectNegation;
        if (edgeEffect6 != null) {
            edgeEffect6.setSize(IntSize.m6795getWidthimpl(size), IntSize.m6794getHeightimpl(size));
        }
        EdgeEffect edgeEffect7 = this.leftEffectNegation;
        if (edgeEffect7 != null) {
            edgeEffect7.setSize(IntSize.m6794getHeightimpl(size), IntSize.m6795getWidthimpl(size));
        }
        EdgeEffect edgeEffect8 = this.rightEffectNegation;
        if (edgeEffect8 != null) {
            edgeEffect8.setSize(IntSize.m6794getHeightimpl(size), IntSize.m6795getWidthimpl(size));
        }
    }
}
