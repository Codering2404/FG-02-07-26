    ...
    public boolean requestPostMessageChannel(Uri postMessageOrigin) {
        try {
            ...
            if (pendingIntent != null) {
                return iCustomTabsService.requestPostMessageChannelWithExtras(this.mCallback, postMessageOrigin, createBundleWithId(null));
            }
            return iCustomTabsService.requestPostMessageChannel(this.mCallback, postMessageOrigin);
        } catch (RemoteException e) {
            return false;
        }
    }
