...
public final class TextFieldKeyInput {
    ...
    private final CommitTextCommand m1065typedCommandZmokQxo(KeyEvent event) {
        Integer numM986consumeZmokQxo;
        if (!TextFieldKeyInput_androidKt.m1070isTypedEventZmokQxo(event) || (numM986consumeZmokQxo = this.keyCombiner.m986consumeZmokQxo(event)) == null) {
            return null;
        }
        int codePoint = numM986consumeZmokQxo.intValue();
    ...
    public final boolean m1066processZmokQxo(KeyEvent event) {
        final KeyCommand command;
        CommitTextCommand it = m1065typedCommandZmokQxo(event);
        if (it != null) {
            if (!this.editable) {
                return false;
            }
        ...
        if (!KeyEventType.m5212equalsimpl0(KeyEvent_androidKt.m5220getTypeZmokQxo(event), KeyEventType.INSTANCE.m5216getKeyDownCS__XNY()) || (command = this.keyMapping.mo988mapZmokQxo(event)) == null || (command.getEditsText() && !this.editable)) {
            return false;
        }
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[command.ordinal()]) {
                    ...
                    case 20:
                        List<EditCommand> listDeleteIfSelectedOr = $this$commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.3
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection $this$deleteIfSelectedOr) {
                                return new DeleteSurroundingTextCommand(TextRange.m6086getEndimpl($this$deleteIfSelectedOr.getSelection()) - $this$deleteIfSelectedOr.getPrecedingCharacterIndex(), 0);
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr2 = $this$commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.4
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection $this$deleteIfSelectedOr) {
                                ...
                                if (nextCharacterIndex != -1) {
                                    return new DeleteSurroundingTextCommand(0, nextCharacterIndex - TextRange.m6086getEndimpl($this$deleteIfSelectedOr.getSelection()));
                                }
                                return null;
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr3 = $this$commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.5
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection $this$deleteIfSelectedOr) {
                                ...
                                if (previousWordOffset != null) {
                                    ...
                                    deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m6086getEndimpl($this$deleteIfSelectedOr.getSelection()) - it4, 0);
                                } else {
                        ...
                        List<EditCommand> listDeleteIfSelectedOr4 = $this$commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.6
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection $this$deleteIfSelectedOr) {
                                ...
                                if (nextWordOffset != null) {
                                    ...
                                    deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(0, it4 - TextRange.m6086getEndimpl($this$deleteIfSelectedOr.getSelection()));
                                } else {
                                    deleteSurroundingTextCommand = null;
                                }
                                return deleteSurroundingTextCommand;
                    ...
                    case 26:
                        ...
                        if (!singleLine) {
                            ...
                            textFieldKeyInput.getState().getOnImeActionPerformed().invoke(ImeAction.m6252boximpl(this.imeAction));
                        }
                        break;
                    case 27:
    ...
    private final void commandExecutionContext(Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        if (!TextRange.m6084equalsimpl0(preparedSelection.getSelection(), this.value.getSelection()) || !Intrinsics.areEqual(preparedSelection.getAnnotatedString(), this.value.getText())) {
