...
final class PullRefreshNestedScrollConnection implements NestedScrollConnection {
    ...
    public long mo749onPreScrollOzD1aCk(long available, int source) {
        ...
        if (NestedScrollSource.m5244equalsimpl0(source, NestedScrollSource.INSTANCE.m5256getUserInputWNlRxjI()) && Offset.m3922getYimpl(available) < 0.0f) {
            return OffsetKt.Offset(0.0f, this.onPull.invoke(Float.valueOf(Offset.m3922getYimpl(available))).floatValue());
        }
        return Offset.INSTANCE.m3937getZeroF1C5BW0();
    }
    ...
    */
    public java.lang.Object mo748onPreFlingQWom1Mo(long r8, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r10) {
        /*
            r7 = this;
        ...
        L35:
            ...
            float r4 = androidx.compose.ui.unit.Velocity.m6863getYimpl(r8)
        ...
        L50:
            ...
            androidx.compose.ui.unit.Velocity r8 = androidx.compose.ui.unit.Velocity.m6853boximpl(r8)
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.pullrefresh.PullRefreshNestedScrollConnection.mo748onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
