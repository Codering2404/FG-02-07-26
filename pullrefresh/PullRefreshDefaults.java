...
public final class PullRefreshDefaults {
    ...
    private static final float RefreshThreshold = Dp.m6625constructorimpl(80);
    private static final float RefreshingOffset = Dp.m6625constructorimpl(56);

    private PullRefreshDefaults() {
    }

    /* JADX INFO: renamed from: getRefreshThreshold-D9Ej5fM, reason: not valid java name */
    public final float m1732getRefreshThresholdD9Ej5fM() {
        return RefreshThreshold;
    }

    /* JADX INFO: renamed from: getRefreshingOffset-D9Ej5fM, reason: not valid java name */
    public final float m1733getRefreshingOffsetD9Ej5fM() {
