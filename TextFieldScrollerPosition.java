...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation initialOrientation, float initial) {
        ...
        this.previousSelection = TextRange.INSTANCE.m6096getZerod9O1mEE();
    ...
    */
    ...
    public final int m1073getOffsetToFollow5zctL8(long selection) {
        return TextRange.m6091getStartimpl(selection) != TextRange.m6091getStartimpl(this.previousSelection) ? TextRange.m6091getStartimpl(selection) : TextRange.m6086getEndimpl(selection) != TextRange.m6086getEndimpl(this.previousSelection) ? TextRange.m6086getEndimpl(selection) : TextRange.m6089getMinimpl(selection);
    }
