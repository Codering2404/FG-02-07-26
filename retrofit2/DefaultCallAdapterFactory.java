...
final class DefaultCallAdapterFactory extends CallAdapter.Factory {
    ...
    static final class ExecutorCallbackCall<T> implements Call<T> {
        ...
        class AnonymousClass1 implements Callback<T> {
            ...
            public void onResponse(Call<T> call, final Response<T> response) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.DefaultCallAdapterFactory$ExecutorCallbackCall$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m8765lambda$onResponse$0$retrofit2DefaultCallAdapterFactory$ExecutorCallbackCall$1(callback, response);
                    }
                });
            }
            ...
            /* synthetic */ void m8765lambda$onResponse$0$retrofit2DefaultCallAdapterFactory$ExecutorCallbackCall$1(Callback callback, Response response) {
            ...
            /* synthetic */ void m8764lambda$onFailure$1$retrofit2DefaultCallAdapterFactory$ExecutorCallbackCall$1(Callback callback, Throwable t) {
            ...
            public void onFailure(Call<T> call, final Throwable t) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.DefaultCallAdapterFactory$ExecutorCallbackCall$1$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m8764lambda$onFailure$1$retrofit2DefaultCallAdapterFactory$ExecutorCallbackCall$1(callback, t);
                    }
                });
            }
        }
