...
public final class BottomNavigationDefaults {
    ...
    private static final float Elevation = Dp.m6625constructorimpl(8);
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        WindowInsets windowInsetsM744onlybOOhFvg = WindowInsetsKt.m744onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, $composer, 6), WindowInsetsSides.m756plusgK_yJZ4(WindowInsetsSides.INSTANCE.m766getHorizontalJoeWqyM(), WindowInsetsSides.INSTANCE.m764getBottomJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return windowInsetsM744onlybOOhFvg;
    }
}
