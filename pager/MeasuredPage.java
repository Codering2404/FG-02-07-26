...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            long offset = m908getOffsetBjo55l4(index);
            if (!this.reverseLayout) {
                $this$place_u24lambda_u247 = $this$place_u24lambda_u2472;
            } else {
                if (this.isVertical) {
                    mainAxisOffset = IntOffset.m6753getXimpl(offset);
                    $this$place_u24lambda_u247 = $this$place_u24lambda_u2472;
                } else {
                    int mainAxisOffset2 = IntOffset.m6753getXimpl(offset);
                    $this$place_u24lambda_u247 = $this$place_u24lambda_u2472;
                    mainAxisOffset = (this.mainAxisLayoutSize - mainAxisOffset2) - getMainAxisSize(placeable);
                }
                if (this.isVertical) {
                    int mainAxisOffset3 = IntOffset.m6754getYimpl(offset);
                    int mainAxisOffset4 = this.mainAxisLayoutSize;
                    iM6754getYimpl = (mainAxisOffset4 - mainAxisOffset3) - getMainAxisSize(placeable);
                } else {
                    iM6754getYimpl = IntOffset.m6754getYimpl(offset);
                }
                long $this$copy_u2d4Tuh3kE$iv = IntOffsetKt.IntOffset(mainAxisOffset, iM6754getYimpl);
    ...
    private final long m907copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {
        return IntOffsetKt.IntOffset(this.isVertical ? IntOffset.m6753getXimpl($this$copy_u2d4Tuh3kE) : function1.invoke(Integer.valueOf(IntOffset.m6753getXimpl($this$copy_u2d4Tuh3kE))).intValue(), this.isVertical ? function1.invoke(Integer.valueOf(IntOffset.m6754getYimpl($this$copy_u2d4Tuh3kE))).intValue() : IntOffset.m6754getYimpl($this$copy_u2d4Tuh3kE));
    }
}
