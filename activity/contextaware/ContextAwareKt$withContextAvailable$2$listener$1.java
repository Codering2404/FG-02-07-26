...
public final class ContextAwareKt$withContextAvailable$2$listener$1 implements OnContextAvailableListener {
    ...
    public void onContextAvailable(Context context) {
        Object objM7023constructorimpl;
        ...
        try {
            ...
            objM7023constructorimpl = Result.m7023constructorimpl(function1.invoke(context));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM7023constructorimpl = Result.m7023constructorimpl(ResultKt.createFailure(th));
        }
        continuation.resumeWith(objM7023constructorimpl);
    }
}
