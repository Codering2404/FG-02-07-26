...
final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float before, float after, Function1<? super InspectorInfo, Unit> function1) {
        ...
        if ((this.before >= 0.0f || Dp.m6630equalsimpl0(this.before, Dp.INSTANCE.m6645getUnspecifiedD9Ej5fM())) && (this.after >= 0.0f || Dp.m6630equalsimpl0(this.after, Dp.INSTANCE.m6645getUnspecifiedD9Ej5fM()))) {
        } else {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, otherModifier.alignmentLine) && Dp.m6630equalsimpl0(this.before, otherModifier.before) && Dp.m6630equalsimpl0(this.after, otherModifier.after);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = this.alignmentLine.hashCode();
        return (((result * 31) + Dp.m6631hashCodeimpl(this.before)) * 31) + Dp.m6631hashCodeimpl(this.after);
    }
}
