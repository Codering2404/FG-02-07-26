...
public abstract class RectListNode extends Modifier.Node implements GlobalPositionAwareModifierNode {
    ...
    private final Rect calcBounds(LayoutCoordinates layoutCoordinates, androidx.compose.ui.geometry.Rect rect) {
        ...
        long topLeft = root.mo5499localPositionOfR5De75A(layoutCoordinates, rect.m3956getTopLeftF1C5BW0());
        long topRight = root.mo5499localPositionOfR5De75A(layoutCoordinates, rect.m3957getTopRightF1C5BW0());
        long bottomLeft = root.mo5499localPositionOfR5De75A(layoutCoordinates, rect.m3949getBottomLeftF1C5BW0());
        long bottomRight = root.mo5499localPositionOfR5De75A(layoutCoordinates, rect.m3950getBottomRightF1C5BW0());
        float left = ComparisonsKt.minOf(Offset.m3921getXimpl(topLeft), Offset.m3921getXimpl(topRight), Offset.m3921getXimpl(bottomLeft), Offset.m3921getXimpl(bottomRight));
        float top = ComparisonsKt.minOf(Offset.m3922getYimpl(topLeft), Offset.m3922getYimpl(topRight), Offset.m3922getYimpl(bottomLeft), Offset.m3922getYimpl(bottomRight));
        float right = ComparisonsKt.maxOf(Offset.m3921getXimpl(topLeft), Offset.m3921getXimpl(topRight), Offset.m3921getXimpl(bottomLeft), Offset.m3921getXimpl(bottomRight));
        float bottom = ComparisonsKt.maxOf(Offset.m3922getYimpl(topLeft), Offset.m3922getYimpl(topRight), Offset.m3922getYimpl(bottomLeft), Offset.m3922getYimpl(bottomRight));
