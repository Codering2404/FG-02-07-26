...
public final class AndroidExternalSurfaceZOrder {
    ...
    private static final int Behind = m216constructorimpl(0);
    private static final int MediaOverlay = m216constructorimpl(1);
    private static final int OnTop = m216constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ AndroidExternalSurfaceZOrder m215boximpl(int i) {
        return new AndroidExternalSurfaceZOrder(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m216constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m217equalsimpl(int i, Object obj) {
        return (obj instanceof AndroidExternalSurfaceZOrder) && i == ((AndroidExternalSurfaceZOrder) obj).m221unboximpl();
    }
    ...
    public static int m219hashCodeimpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m217equalsimpl(this.zOrder, obj);
    }

    public int hashCode() {
        return m219hashCodeimpl(this.zOrder);
    }

    public String toString() {
        return m220toStringimpl(this.zOrder);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ int m221unboximpl() {
        return this.zOrder;
    }
