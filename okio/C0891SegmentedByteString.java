...
public final class C0891SegmentedByteString extends ByteString {
    ...
    public C0891SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        ...
        return new C0891SegmentedByteString(newSegments$iv, newDirectory$iv);
    }
    ...
    public void write$okio(Buffer buffer, int offset, int byteCount) {
        C0891SegmentedByteString $this$commonWrite$iv;
        Intrinsics.checkNotNullParameter(buffer, "buffer");
        C0891SegmentedByteString $this$commonWrite$iv2 = this;
    ...
    public boolean rangeEquals(int offset, ByteString other, int otherOffset, int byteCount) {
        ...
        C0891SegmentedByteString $this$commonRangeEquals$iv = this;
        ...
        while (pos$iv$iv < endIndex$iv$iv) {
            ...
            C0891SegmentedByteString $this$commonRangeEquals$iv2 = $this$commonRangeEquals$iv;
    ...
    public void copyInto(int offset, byte[] target, int targetOffset, int byteCount) {
        ...
        C0891SegmentedByteString $this$commonCopyInto$iv = this;
