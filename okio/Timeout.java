...
public class Timeout {
    ...
    public static final class Companion {
        ...
        public final Timeout m8762timeoutHG0u8IE(Timeout timeout, long duration) {
            Intrinsics.checkNotNullParameter(timeout, "$this$timeout");
            return timeout.timeout(Duration.m8390getInWholeNanosecondsimpl(duration), TimeUnit.NANOSECONDS);
        }
