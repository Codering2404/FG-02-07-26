...
public final class LazyGridMeasuredItem implements LazyGridItemInfo, LazyLayoutMeasuredItem {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            if (animation != null) {
                ...
                if ((m816getMainAxisgyyYBs(offset) <= minOffset && m816getMainAxisgyyYBs(animatedOffset) <= minOffset) || (m816getMainAxisgyyYBs(offset) >= maxOffset && m816getMainAxisgyyYBs(animatedOffset) >= maxOffset)) {
            ...
            if (!this.reverseLayout) {
                ...
                if (getIsVertical()) {
                    layer2 = layer;
                    mainAxisSize = IntOffset.m6753getXimpl($this$copy_u2d4Tuh3kE$iv);
                } else {
                ...
                if (getIsVertical()) {
                    ...
                    iM6754getYimpl = (this.mainAxisLayoutSize - mainAxisOffset2) - getMainAxisSize(placeable);
                } else {
                    iM6754getYimpl = IntOffset.m6754getYimpl($this$copy_u2d4Tuh3kE$iv);
                }
                offset = IntOffsetKt.IntOffset(mainAxisSize, iM6754getYimpl);
            }
            long offset2 = IntOffset.m6757plusqkQi6aY(offset, this.visualOffset);
            if (animation != null) {
            ...
            if (getIsVertical()) {
                if (layer2 != null) {
                    ...
                    Placeable.PlacementScope.m5559placeWithLayeraW9wM$default($this$place_u24lambda_u2472, placeable, offset2, layer2, 0.0f, 4, (Object) null);
                } else {
                    $this$place_u24lambda_u2472 = $this$place_u24lambda_u247;
                    Placeable.PlacementScope.m5558placeWithLayeraW9wM$default($this$place_u24lambda_u2472, placeable, offset2, 0.0f, (Function1) null, 6, (Object) null);
                }
            } else {
                $this$place_u24lambda_u2472 = $this$place_u24lambda_u247;
                if (layer2 != null) {
                    Placeable.PlacementScope.m5557placeRelativeWithLayeraW9wM$default($this$place_u24lambda_u2472, placeable, offset2, layer2, 0.0f, 4, (Object) null);
                } else {
                    Placeable.PlacementScope.m5556placeRelativeWithLayeraW9wM$default($this$place_u24lambda_u2472, placeable, offset2, 0.0f, (Function1) null, 6, (Object) null);
                }
            }
        }
    }
    ...
    private final int m816getMainAxisgyyYBs(long $this$mainAxis) {
    ...
    private final long m815copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {
