...
final class LimitInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        if (layoutDirection == LayoutDirection.Ltr) {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m760getAllowLeftInLtrJoeWqyM$foundation_layout_release();
        } else {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m761getAllowLeftInRtlJoeWqyM$foundation_layout_release();
        }
        boolean allowLeft = WindowInsetsSides.m754hasAnybkgdKaI$foundation_layout_release(this.sides, layoutDirectionSide);
        if (allowLeft) {
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        int layoutDirectionSide;
        if (layoutDirection == LayoutDirection.Ltr) {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m762getAllowRightInLtrJoeWqyM$foundation_layout_release();
        } else {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m763getAllowRightInRtlJoeWqyM$foundation_layout_release();
        }
        boolean allowRight = WindowInsetsSides.m754hasAnybkgdKaI$foundation_layout_release(this.sides, layoutDirectionSide);
        if (allowRight) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof LimitInsets) {
            return Intrinsics.areEqual(this.insets, ((LimitInsets) other).insets) && WindowInsetsSides.m753equalsimpl0(this.sides, ((LimitInsets) other).sides);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (result * 31) + WindowInsetsSides.m755hashCodeimpl(this.sides);
    }
