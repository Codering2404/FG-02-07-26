...
public final class StylusHandwritingKt {
    private static final float HandwritingBoundsVerticalOffset = Dp.m6625constructorimpl(40);
    private static final float HandwritingBoundsHorizontalOffset = Dp.m6625constructorimpl(10);
    ...
    public static final Modifier stylusHandwriting(Modifier $this$stylusHandwriting, boolean enabled, Function0<Boolean> function0) {
        if (enabled && StylusHandwriting_androidKt.isStylusHandwritingSupported()) {
            return PaddingKt.m674paddingVpY3zN4($this$stylusHandwriting.then(new StylusHandwritingElementWithNegativePadding(function0)), HandwritingBoundsHorizontalOffset, HandwritingBoundsVerticalOffset);
        }
