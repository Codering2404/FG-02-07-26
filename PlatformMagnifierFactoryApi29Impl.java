...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public PlatformMagnifierImpl mo319createnHHXs2Y(View view, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, Density density, float initialZoom) {
        ...
        long pixelSize = density.mo366toSizeXkaWNTQ(size);
        float pixelCornerRadius = density.mo365toPx0680j_4(cornerRadius);
        float pixelElevation = density.mo365toPx0680j_4(elevation);
        ...
        if (pixelSize != InlineClassHelperKt.UnspecifiedPackedFloats) {
            $this$create_nHHXs2Y_u24lambda_u241_u24lambda_u240.setSize(MathKt.roundToInt(Size.m3990getWidthimpl(pixelSize)), MathKt.roundToInt(Size.m3987getHeightimpl(pixelSize)));
        }
    ...
    public static final class PlatformMagnifierImpl extends PlatformMagnifierFactoryApi28Impl.PlatformMagnifierImpl {
        ...
        public void mo318updateWko1d7g(long sourceCenter, long magnifierCenter, float zoom) {
            ...
            if (OffsetKt.m3940isSpecifiedk4lQ0M(magnifierCenter)) {
                getMagnifier().show(Offset.m3921getXimpl(sourceCenter), Offset.m3922getYimpl(sourceCenter), Offset.m3921getXimpl(magnifierCenter), Offset.m3922getYimpl(magnifierCenter));
            } else {
                getMagnifier().show(Offset.m3921getXimpl(sourceCenter), Offset.m3922getYimpl(sourceCenter));
            }
        }
    }
}
