...
public class ClickableNode extends AbstractClickableNode {
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (ClickableNode.this.getEnabled()) {
                        this.label = 1;
                        if (ClickableNode.this.m199handlePressInteractiond4ec7I($this$detectTapAndPress, offset, this) == coroutine_suspended) {
    ...
    static /* synthetic */ Object clickPointerInput$suspendImpl(ClickableNode $this, PointerInputScope $receiver, Continuation<? super Unit> continuation) {
        Object objDetectTapAndPress = TapGestureDetectorKt.detectTapAndPress($receiver, $this.new AnonymousClass2(null), new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.ClickableNode.clickPointerInput.3
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                m271invokek4lQ0M(offset.getPackedValue());
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
            public final void m271invokek4lQ0M(long it) {
                if (ClickableNode.this.getEnabled()) {
    ...
    public final void m269updateQzZPfjk(MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
