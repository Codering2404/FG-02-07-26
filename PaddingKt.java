...
public final class PaddingKt {
    ...
    public static /* synthetic */ Modifier m677paddingqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m6625constructorimpl(0);
        }
        int $i$f$getDp = i & 2;
        if ($i$f$getDp != 0) {
            f2 = Dp.m6625constructorimpl(0);
        }
        int $i$f$getDp2 = i & 4;
        if ($i$f$getDp2 != 0) {
            f3 = Dp.m6625constructorimpl(0);
        }
        if ((i & 8) != 0) {
            f4 = Dp.m6625constructorimpl(0);
        }
        return m676paddingqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* JADX INFO: renamed from: padding-qDBjuR0, reason: not valid java name */
    public static final Modifier m676paddingqDBjuR0(Modifier $this$padding_u2dqDBjuR0, final float start, final float top, final float end, final float bottom) {
        return $this$padding_u2dqDBjuR0.then(new PaddingElement(start, top, end, bottom, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt.padding.1
            ...
            public final void invoke2(InspectorInfo $this$$receiver) {
                ...
                $this$$receiver.getProperties().set("start", Dp.m6623boximpl(start));
                $this$$receiver.getProperties().set("top", Dp.m6623boximpl(top));
                $this$$receiver.getProperties().set("end", Dp.m6623boximpl(end));
                $this$$receiver.getProperties().set("bottom", Dp.m6623boximpl(bottom));
            }
        }, null));
    }
    ...
    public static final Modifier m674paddingVpY3zN4(Modifier $this$padding_u2dVpY3zN4, final float horizontal, final float vertical) {
        return $this$padding_u2dVpY3zN4.then(new PaddingElement(horizontal, vertical, horizontal, vertical, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt.padding.2
            ...
            public final void invoke2(InspectorInfo $this$$receiver) {
                $this$$receiver.setName("padding");
                $this$$receiver.getProperties().set("horizontal", Dp.m6623boximpl(horizontal));
                $this$$receiver.getProperties().set("vertical", Dp.m6623boximpl(vertical));
            }
        }, null));
    }

    /* JADX INFO: renamed from: padding-3ABfNKs, reason: not valid java name */
    public static final Modifier m673padding3ABfNKs(Modifier $this$padding_u2d3ABfNKs, final float all) {
        return $this$padding_u2d3ABfNKs.then(new PaddingElement(all, all, all, all, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt.padding.3
            ...
            public final void invoke2(InspectorInfo $this$$receiver) {
                $this$$receiver.setName("padding");
                $this$$receiver.setValue(Dp.m6623boximpl(all));
            }
        }, null));
    }
    ...
    public static final Modifier padding(Modifier $this$padding, final PaddingValues paddingValues) {
        return $this$padding.then(new PaddingValuesElement(paddingValues, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt.padding.4
            ...
            public final void invoke2(InspectorInfo $this$$receiver) {
                $this$$receiver.setName("padding");
                $this$$receiver.getProperties().set("paddingValues", paddingValues);
            }
        }));
    }
    ...
    public static final Modifier m671absolutePaddingqDBjuR0(Modifier $this$absolutePadding_u2dqDBjuR0, final float left, final float top, final float right, final float bottom) {
        return $this$absolutePadding_u2dqDBjuR0.then(new PaddingElement(left, top, right, bottom, false, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt$absolutePadding$1
            ...
            public final void invoke2(InspectorInfo $this$$receiver) {
                ...
                $this$$receiver.getProperties().set("left", Dp.m6623boximpl(left));
                $this$$receiver.getProperties().set("top", Dp.m6623boximpl(top));
                $this$$receiver.getProperties().set("right", Dp.m6623boximpl(right));
                $this$$receiver.getProperties().set("bottom", Dp.m6623boximpl(bottom));
            }
        }, null));
    }
    ...
    public static final float calculateStartPadding(PaddingValues $this$calculateStartPadding, LayoutDirection layoutDirection) {
        if (layoutDirection == LayoutDirection.Ltr) {
            return $this$calculateStartPadding.mo624calculateLeftPaddingu2uoSUM(layoutDirection);
        }
        return $this$calculateStartPadding.mo625calculateRightPaddingu2uoSUM(layoutDirection);
    }

    public static final float calculateEndPadding(PaddingValues $this$calculateEndPadding, LayoutDirection layoutDirection) {
        if (layoutDirection == LayoutDirection.Ltr) {
            return $this$calculateEndPadding.mo625calculateRightPaddingu2uoSUM(layoutDirection);
        }
        return $this$calculateEndPadding.mo624calculateLeftPaddingu2uoSUM(layoutDirection);
    }

    /* JADX INFO: renamed from: PaddingValues-0680j_4, reason: not valid java name */
    public static final PaddingValues m666PaddingValues0680j_4(float all) {
    ...
    public static final PaddingValues m667PaddingValuesYgX7TsA(float horizontal, float vertical) {
    ...
    public static final PaddingValues m669PaddingValuesa9UjIt4(float start, float top, float end, float bottom) {
