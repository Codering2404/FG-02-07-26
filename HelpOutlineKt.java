...
public final class HelpOutlineKt {
    ...
    public static final ImageVector getHelpOutline(Icons.AutoMirrored.TwoTone $this$HelpOutline) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _helpOutline = ImageVector.Builder.m4845addPathoIyEayM$default($this$_get_HelpOutline__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
